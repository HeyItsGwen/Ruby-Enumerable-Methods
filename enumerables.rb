...
module Enumerable
  # rubocop:disable Style/RedundantSelf, Style/For, Metrics/CyclomaticComplexity, Metrics/PerceivedComplexity
  ...
  # rubocop: enable Style/RedundantSelf, Style/For, Metrics/PerceivedComplexity, Metrics/CyclomaticComplexity
end
